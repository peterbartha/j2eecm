package ejb.container.diagram.navigator;
...
import ejb.container.diagram.providers.ModelParserProvider;
...
public class ModelNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case EnumLiteralEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?components?EnumLiteral", ModelElementTypes.EnumLiteral_3019); //$NON-NLS-1$
		...
		case EnumElementEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?components?EnumElement", ModelElementTypes.EnumElement_2013); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case EnumLiteralEditPart.VISUAL_ID:
			return getEnumLiteral_3019Text(view);
		case MessageDrivenBeanEditPart.VISUAL_ID:
		...
		case EnumElementEditPart.VISUAL_ID:
			return getEnumElement_2013Text(view);
		case StatefulSessionBeanEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getEnumLiteral_3019Text(View view) {
		IParser parser = ModelParserProvider.getParser(
				ModelElementTypes.EnumLiteral_3019,
				view.getElement() != null ? view.getElement() : view,
				ModelVisualIDRegistry
	 ...
	 * @generated
	 */
	private String getEnumElement_2013Text(View view) {
		IParser parser = ModelParserProvider.getParser(
				ModelElementTypes.EnumElement_2013,
				view.getElement() != null ? view.getElement() : view,
				ModelVisualIDRegistry
