 ...
 * @generated
 */
public class InterfaceElementPropertyCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getInterfaceElementPropertyCompartment_7005SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Property2EditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getInterfaceElementPropertyCompartment_7005SemanticChildren((View) getHost()
						.getModel());
