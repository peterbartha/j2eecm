 ...
 * @generated
 */
public class MessageDrivenBeanPropertyCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getMessageDrivenBeanPropertyCompartment_7009SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Property4EditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getMessageDrivenBeanPropertyCompartment_7009SemanticChildren((View) getHost()
						.getModel());
