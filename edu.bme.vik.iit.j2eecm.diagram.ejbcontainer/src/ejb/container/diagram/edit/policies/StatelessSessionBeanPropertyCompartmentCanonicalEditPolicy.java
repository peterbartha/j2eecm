...
import ejb.container.diagram.part.ModelDiagramUpdater;
import ejb.container.diagram.part.ModelNodeDescriptor;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class StatelessSessionBeanPropertyCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getClassifierElement_OwnedProperty();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getStatelessSessionBeanPropertyCompartment_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Property6EditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getStatelessSessionBeanPropertyCompartment_7003SemanticChildren((View) getHost()
						.getModel());
