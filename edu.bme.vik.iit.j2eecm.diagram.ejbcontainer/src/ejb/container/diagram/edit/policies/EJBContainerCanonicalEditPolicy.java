...
import ejb.container.diagram.part.ModelLinkDescriptor;
...
public class EJBContainerCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	private Collection<ModelLinkDescriptor> collectAllLinks(View view,
		...
		case EnumElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ModelDiagramUpdater
						.getEnumElement_2013ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		...
		case EnumLiteralEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(ModelDiagramUpdater
						.getEnumLiteral_3019ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
