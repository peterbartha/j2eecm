 ...
 * @generated
 */
public class PackageElementClassElementCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getPackageElement_PackagedElement();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getPackageElementClassElementCompartment_7013SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ClassElement2EditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getPackageElementClassElementCompartment_7013SemanticChildren((View) getHost()
						.getModel());
