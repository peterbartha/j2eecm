 ...
 * @generated
 */
public class StatefulSessionBeanOpearionCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getStatefulSessionBeanOpearionCompartment_7012SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Operation5EditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getStatefulSessionBeanOpearionCompartment_7012SemanticChildren((View) getHost()
						.getModel());
