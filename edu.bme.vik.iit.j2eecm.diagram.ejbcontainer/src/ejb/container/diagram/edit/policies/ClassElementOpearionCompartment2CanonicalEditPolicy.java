 ...
 * @generated
 */
public class ClassElementOpearionCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getClassElementOpearionCompartment_7015SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return Operation7EditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getClassElementOpearionCompartment_7015SemanticChildren((View) getHost()
						.getModel());
