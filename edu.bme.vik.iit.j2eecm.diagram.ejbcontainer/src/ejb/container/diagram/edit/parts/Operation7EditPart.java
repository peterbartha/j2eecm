...
import ejb.container.diagram.edit.policies.Operation7ItemSemanticEditPolicy;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class Operation7EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Operation7EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Operation7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationNameParametersOpeartion6EditPart) {
			((OperationNameParametersOpeartion6EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureOperationNameFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(0, 27);
		return result;
	}
