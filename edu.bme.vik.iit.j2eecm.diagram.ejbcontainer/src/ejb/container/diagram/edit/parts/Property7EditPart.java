...
import ejb.container.diagram.edit.policies.Property7ItemSemanticEditPolicy;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class Property7EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Property7ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PropertyNamePropertyType6EditPart) {
			((PropertyNamePropertyType6EditPart) childEditPart)
