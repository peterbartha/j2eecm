 ...
 * @generated
 */
public class InterfaceElementNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InterfaceElementNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.InterfaceElementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
