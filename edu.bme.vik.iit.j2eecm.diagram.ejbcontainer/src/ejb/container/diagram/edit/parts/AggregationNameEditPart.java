 ...
 * @generated
 */
public class AggregationNameEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(ejb.container.diagram.edit.parts.AggregationNameEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AggregationNameEditPart(View view) {
		super(view);
	}
