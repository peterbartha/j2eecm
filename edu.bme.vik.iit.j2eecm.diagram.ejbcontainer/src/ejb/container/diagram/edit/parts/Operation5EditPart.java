...
import ejb.container.diagram.edit.policies.Operation5ItemSemanticEditPolicy;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class Operation5EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationNameParametersOpeartion4EditPart) {
			((OperationNameParametersOpeartion4EditPart) childEditPart)
