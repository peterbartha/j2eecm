 ...
 * @generated
 */
public class StatefulSessionBeanNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public StatefulSessionBeanNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.StatefulSessionBeanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
