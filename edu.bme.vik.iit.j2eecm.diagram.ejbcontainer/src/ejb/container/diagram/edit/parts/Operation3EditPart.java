...
import ejb.container.diagram.edit.policies.Operation3ItemSemanticEditPolicy;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class Operation3EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationNameParametersOpeartion2EditPart) {
			((OperationNameParametersOpeartion2EditPart) childEditPart)
