...
import ejb.container.diagram.edit.policies.ModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EntityBeanVisibilityEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntityBeanVisibilityEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ModelTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new EJBContainerEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider
					.getParser(
							ModelElementTypes.EntityBean_2002,
							getParserElement(),
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.EntityBeanVisibilityEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null,
					ModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
