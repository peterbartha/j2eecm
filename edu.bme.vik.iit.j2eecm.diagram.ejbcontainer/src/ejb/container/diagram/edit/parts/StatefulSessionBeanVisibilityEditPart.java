 ...
 * @generated
 */
public class StatefulSessionBeanVisibilityEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public StatefulSessionBeanVisibilityEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.StatefulSessionBeanVisibilityEditPart.VISUAL_ID));
		}
		return parser;
	}
