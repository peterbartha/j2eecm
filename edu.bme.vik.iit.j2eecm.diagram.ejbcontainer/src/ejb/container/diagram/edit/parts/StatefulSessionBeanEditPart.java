...
import ejb.container.diagram.edit.policies.StatefulSessionBeanItemSemanticEditPolicy;
...
public class StatefulSessionBeanEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ejb.container.diagram.edit.parts.StatefulSessionBeanEditPart) {
			types.add(ModelElementTypes.Generalization_4002);
		}
