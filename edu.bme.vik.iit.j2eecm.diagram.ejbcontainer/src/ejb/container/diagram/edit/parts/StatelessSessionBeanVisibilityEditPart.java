 ...
 * @generated
 */
public class StatelessSessionBeanVisibilityEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public StatelessSessionBeanVisibilityEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.StatelessSessionBeanVisibilityEditPart.VISUAL_ID));
		}
		return parser;
	}
