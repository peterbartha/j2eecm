 ...
 * @generated
 */
public class AggregationLowerBoundUpperBoundEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(ejb.container.diagram.edit.parts.AggregationLowerBoundUpperBoundEditPart.VISUAL_ID),
				new Point(0, 60));
	}
	 ...
	 * @generated
	 */
	public AggregationLowerBoundUpperBoundEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new EJBContainerEditPart.LinkLabelDragPolicy());
	}
