...
import ejb.container.diagram.edit.policies.InterfaceElementItemSemanticEditPolicy;
...
public class InterfaceElementEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ejb.container.diagram.edit.parts.InterfaceElementEditPart) {
			types.add(ModelElementTypes.Generalization_4002);
		}
