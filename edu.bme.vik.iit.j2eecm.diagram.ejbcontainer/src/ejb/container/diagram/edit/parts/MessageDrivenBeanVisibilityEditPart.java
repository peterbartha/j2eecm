 ...
 * @generated
 */
public class MessageDrivenBeanVisibilityEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MessageDrivenBeanVisibilityEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.MessageDrivenBeanVisibilityEditPart.VISUAL_ID));
		}
		return parser;
	}
