 ...
 * @generated
 */
public class MessageDrivenBeanNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MessageDrivenBeanNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.MessageDrivenBeanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
