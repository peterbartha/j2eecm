...
import ejb.container.diagram.edit.policies.Operation2ItemSemanticEditPolicy;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class Operation2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationNameParametersOpeartionEditPart) {
			((OperationNameParametersOpeartionEditPart) childEditPart)
