 ...
 * @generated
 */
public class OperationNameVisibilityEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public OperationNameVisibilityEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.OperationNameVisibilityEditPart.VISUAL_ID));
		}
		return parser;
	}
