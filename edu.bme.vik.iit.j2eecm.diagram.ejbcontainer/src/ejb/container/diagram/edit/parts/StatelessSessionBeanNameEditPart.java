 ...
 * @generated
 */
public class StatelessSessionBeanNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public StatelessSessionBeanNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.StatelessSessionBeanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
