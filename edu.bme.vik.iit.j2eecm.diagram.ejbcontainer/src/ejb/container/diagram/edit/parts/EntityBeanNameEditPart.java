 ...
 * @generated
 */
public class EntityBeanNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EntityBeanNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.EntityBeanNameEditPart.VISUAL_ID));
		}
		return parser;
	}
