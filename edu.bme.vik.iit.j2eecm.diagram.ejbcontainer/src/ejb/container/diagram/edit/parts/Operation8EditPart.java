...
import ejb.container.diagram.edit.policies.Operation8ItemSemanticEditPolicy;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class Operation8EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Operation8EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Operation8ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationNameVisibilityEditPart) {
			((OperationNameVisibilityEditPart) childEditPart)
