...
import ejb.container.diagram.edit.policies.ClassElement2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ClassElement2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ClassElement2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ClassElement2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ClassElementName2EditPart) {
			((ClassElementName2EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ejb.container.diagram.edit.parts.ClassElement2EditPart) {
			types.add(ModelElementTypes.Generalization_4002);
		}
		if (targetEditPart instanceof InterfaceElementEditPart) {
			types.add(ModelElementTypes.Aggregation_4003);
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == ModelElementTypes.Property_3014) {
				return getChildBySemanticHint(ModelVisualIDRegistry
						.getType(ClassElementPropertyCompartment2EditPart.VISUAL_ID));
			}
			if (type == ModelElementTypes.Operation_3015) {
				return getChildBySemanticHint(ModelVisualIDRegistry
