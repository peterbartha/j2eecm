...
import ejb.container.diagram.edit.policies.PackageElementItemSemanticEditPolicy;
...
public class PackageElementEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof ejb.container.diagram.edit.parts.PackageElementEditPart) {
			types.add(ModelElementTypes.Generalization_4002);
		}
