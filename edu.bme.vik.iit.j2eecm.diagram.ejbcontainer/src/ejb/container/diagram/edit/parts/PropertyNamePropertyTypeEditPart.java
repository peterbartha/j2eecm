 ...
 * @generated
 */
public class PropertyNamePropertyTypeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PropertyNamePropertyTypeEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.PropertyNamePropertyTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
