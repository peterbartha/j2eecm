...
import ejb.container.diagram.edit.policies.Operation4ItemSemanticEditPolicy;
import ejb.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class Operation4EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof OperationNameParametersOpeartion3EditPart) {
			((OperationNameParametersOpeartion3EditPart) childEditPart)
