 ...
 * @generated
 */
public class PropertyNameVisibilityEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PropertyNameVisibilityEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(ejb.container.diagram.edit.parts.PropertyNameVisibilityEditPart.VISUAL_ID));
		}
		return parser;
	}
