...
public class GeneralizationCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateGeneralization_4002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Generalization newElement = ComponentsFactory.eINSTANCE
				.createGeneralization();
		getContainer().getGeneralizationRelationship().add(newElement);
