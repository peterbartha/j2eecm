...
import ejb.container.diagram.parsers.MessageFormatParser;
...
public class ModelParserProvider extends AbstractProvider implements
	 ...
	 * @generated
	 */
	private IParser enumElementName_5033Parser;

	/**
	 * @generated
	 */
	private IParser getEnumElementName_5033Parser() {
		if (enumElementName_5033Parser == null) {
			EAttribute[] features = new EAttribute[] { ComponentsPackage.eINSTANCE
					.getNamedElement_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			enumElementName_5033Parser = parser;
		}
		return enumElementName_5033Parser;
	}
	 ...
	 * @generated
	 */
	private IParser enumLiteralName_5032Parser;

	/**
	 * @generated
	 */
	private IParser getEnumLiteralName_5032Parser() {
		if (enumLiteralName_5032Parser == null) {
			EAttribute[] features = new EAttribute[] { ComponentsPackage.eINSTANCE
					.getEnumLiteral_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			enumLiteralName_5032Parser = parser;
		}
		return enumLiteralName_5032Parser;
	}
	...
	protected IParser getParser(int visualID) {
		...
		case EnumElementNameEditPart.VISUAL_ID:
			return getEnumElementName_5033Parser();
		...
		case EnumLiteralNameEditPart.VISUAL_ID:
			return getEnumLiteralName_5032Parser();
