...
public class ModelPaletteFactory {
	...
	private ToolEntry createEnum4CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Enum4CreationTool_title,
				Messages.Enum4CreationTool_desc,
				Collections.singletonList(ModelElementTypes.EnumElement_2013));
		entry.setId("createEnum4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ModelElementTypes
				.getImageDescriptor(ModelElementTypes.EnumElement_2013));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createLiteral3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.Literal3CreationTool_title,
				Messages.Literal3CreationTool_desc,
				Collections.singletonList(ModelElementTypes.EnumLiteral_3019));
		entry.setId("createLiteral3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(ModelElementTypes
				.getImageDescriptor(ModelElementTypes.EnumLiteral_3019));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
