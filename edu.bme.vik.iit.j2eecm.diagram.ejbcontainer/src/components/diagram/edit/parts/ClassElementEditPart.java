...
import components.diagram.edit.policies.ClassElementItemSemanticEditPolicy;
...
public class ClassElementEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof components.diagram.edit.parts.ClassElementEditPart) {
			types.add(ModelElementTypes.Generalization_4002);
		}
