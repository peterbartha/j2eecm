...
import components.diagram.edit.policies.MessageDrivenBeanItemSemanticEditPolicy;
...
public class MessageDrivenBeanEditPart extends ShapeNodeEditPart {
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof components.diagram.edit.parts.MessageDrivenBeanEditPart) {
			types.add(ModelElementTypes.Generalization_4002);
		}
