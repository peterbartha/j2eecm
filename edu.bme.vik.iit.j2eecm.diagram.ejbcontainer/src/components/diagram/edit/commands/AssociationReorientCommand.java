...
public class AssociationReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ClassifierElement && newEnd instanceof ClassifierElement)) {
			return false;
		}
		ClassifierElement target = getLink().getTarget();
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssociation_4004(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		ClassifierElement source = getLink().getSource();
		if (!(getLink().eContainer() instanceof EJBContainer)) {
			return false;
		}
		EJBContainer container = (EJBContainer) getLink().eContainer();
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAssociation_4004(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ClassifierElement getOldSource() {
		return (ClassifierElement) oldEnd;
	}

	/**
	 * @generated
	 */
	protected ClassifierElement getNewSource() {
		return (ClassifierElement) newEnd;
	}

	/**
	 * @generated
	 */
	protected ClassifierElement getOldTarget() {
		return (ClassifierElement) oldEnd;
	}
	 ...
	 * @generated
	 */
	protected ClassifierElement getNewTarget() {
		return (ClassifierElement) newEnd;
	}
}
