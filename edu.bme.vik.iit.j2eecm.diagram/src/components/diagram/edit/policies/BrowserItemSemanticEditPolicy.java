 ...
 * @generated
 */
public class BrowserItemSemanticEditPolicy extends
		ModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public BrowserItemSemanticEditPolicy() {
		super(ModelElementTypes.Browser_3001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(outgoingLink) == WebReleationshipEditPart.VISUAL_ID) {
