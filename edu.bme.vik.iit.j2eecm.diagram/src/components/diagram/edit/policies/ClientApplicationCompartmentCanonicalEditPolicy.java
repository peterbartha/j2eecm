 ...
 * @generated
 */
public class ClientApplicationCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getClient_Application();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getClientApplicationCompartment_7002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ApplicationClientEditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getClientApplicationCompartment_7002SemanticChildren((View) getHost()
						.getModel());
