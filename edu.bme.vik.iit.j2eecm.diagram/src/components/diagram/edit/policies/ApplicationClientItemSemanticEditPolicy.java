 ...
 * @generated
 */
public class ApplicationClientItemSemanticEditPolicy extends
		ModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ApplicationClientItemSemanticEditPolicy() {
		super(ModelElementTypes.ApplicationClient_3002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(outgoingLink) == AppReleationshipEditPart.VISUAL_ID) {
