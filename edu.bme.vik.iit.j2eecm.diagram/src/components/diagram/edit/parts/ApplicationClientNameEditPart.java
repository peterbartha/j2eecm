 ...
 * @generated
 */
public class ApplicationClientNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ApplicationClientNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.ApplicationClientNameEditPart.VISUAL_ID));
		}
		return parser;
	}
