 ...
 * @generated
 */
public class ApplicationClientLanguageEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ApplicationClientLanguageEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.ApplicationClientLanguageEditPart.VISUAL_ID));
		}
		return parser;
	}
