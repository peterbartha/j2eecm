 ...
 * @generated
 */
public class DatabaseNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DatabaseNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.DatabaseNameEditPart.VISUAL_ID));
		}
		return parser;
	}
