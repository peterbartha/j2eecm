 ...
 * @generated
 */
public class WebReleationshipProtocolEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(components.diagram.edit.parts.WebReleationshipProtocolEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public WebReleationshipProtocolEditPart(View view) {
		super(view);
	}
