 ...
 * @generated
 */
public class DatabaseDatabaseEngineEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DatabaseDatabaseEngineEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.DatabaseDatabaseEngineEditPart.VISUAL_ID));
		}
		return parser;
	}
