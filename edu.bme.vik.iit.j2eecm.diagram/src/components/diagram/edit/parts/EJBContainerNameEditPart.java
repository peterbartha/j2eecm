 ...
 * @generated
 */
public class EJBContainerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EJBContainerNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.EJBContainerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
