 ...
 * @generated
 */
public class WebContainerServerAppEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public WebContainerServerAppEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.WebContainerServerAppEditPart.VISUAL_ID));
		}
		return parser;
	}
