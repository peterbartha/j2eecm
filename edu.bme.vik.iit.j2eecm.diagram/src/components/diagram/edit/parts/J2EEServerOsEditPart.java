 ...
 * @generated
 */
public class J2EEServerOsEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public J2EEServerOsEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.J2EEServerOsEditPart.VISUAL_ID));
		}
		return parser;
	}
