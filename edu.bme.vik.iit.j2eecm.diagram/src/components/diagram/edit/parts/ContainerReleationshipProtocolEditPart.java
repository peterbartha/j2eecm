 ...
 * @generated
 */
public class ContainerReleationshipProtocolEditPart extends LabelEditPart
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(components.diagram.edit.parts.ContainerReleationshipProtocolEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public ContainerReleationshipProtocolEditPart(View view) {
		super(view);
	}
