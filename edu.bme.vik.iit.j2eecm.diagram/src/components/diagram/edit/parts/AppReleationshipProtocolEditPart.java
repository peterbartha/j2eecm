 ...
 * @generated
 */
public class AppReleationshipProtocolEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(components.diagram.edit.parts.AppReleationshipProtocolEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public AppReleationshipProtocolEditPart(View view) {
		super(view);
	}
