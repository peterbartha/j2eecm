 ...
 * @generated
 */
public class DatabaseOsEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DatabaseOsEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.DatabaseOsEditPart.VISUAL_ID));
		}
		return parser;
	}
