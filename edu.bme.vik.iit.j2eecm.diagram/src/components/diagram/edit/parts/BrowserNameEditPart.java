 ...
 * @generated
 */
public class BrowserNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public BrowserNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.BrowserNameEditPart.VISUAL_ID));
		}
		return parser;
	}
