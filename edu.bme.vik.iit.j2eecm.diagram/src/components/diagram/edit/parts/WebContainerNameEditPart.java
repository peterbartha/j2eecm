 ...
 * @generated
 */
public class WebContainerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WebContainerNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.WebContainerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
