 ...
 * @generated
 */
public class J2EEServerNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public J2EEServerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider
					.getParser(
							ModelElementTypes.J2EEServer_2003,
							getParserElement(),
							ModelVisualIDRegistry
									.getType(components.diagram.edit.parts.J2EEServerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
