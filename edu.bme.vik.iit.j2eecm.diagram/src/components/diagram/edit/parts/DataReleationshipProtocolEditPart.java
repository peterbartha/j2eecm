 ...
 * @generated
 */
public class DataReleationshipProtocolEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(components.diagram.edit.parts.DataReleationshipProtocolEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public DataReleationshipProtocolEditPart(View view) {
		super(view);
	}
