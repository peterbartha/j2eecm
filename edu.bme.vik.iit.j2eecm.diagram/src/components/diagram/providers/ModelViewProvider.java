...
public class ModelViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!ModelEditPart.MODEL_ID.equals(ModelVisualIDRegistry
		...
		return ClientEditPart.VISUAL_ID == visualID
				|| DatabaseEditPart.VISUAL_ID == visualID
				|| J2EEServerEditPart.VISUAL_ID == visualID
				|| BrowserEditPart.VISUAL_ID == visualID
				|| ApplicationClientEditPart.VISUAL_ID == visualID
				|| WebContainerEditPart.VISUAL_ID == visualID
				|| EJBContainerEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case ClientEditPart.VISUAL_ID:
			return createClient_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case DatabaseEditPart.VISUAL_ID:
			return createDatabase_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case J2EEServerEditPart.VISUAL_ID:
			return createJ2EEServer_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case BrowserEditPart.VISUAL_ID:
			return createBrowser_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ApplicationClientEditPart.VISUAL_ID:
			return createApplicationClient_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case WebContainerEditPart.VISUAL_ID:
			return createWebContainer_3003(domainElement, containerView, index,
					persisted, preferencesHint);
		case EJBContainerEditPart.VISUAL_ID:
			return createEJBContainer_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case WebReleationshipEditPart.VISUAL_ID:
			return createWebReleationship_4001(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case DataReleationshipEditPart.VISUAL_ID:
			return createDataReleationship_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case AppReleationshipEditPart.VISUAL_ID:
			return createAppReleationship_4003(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ContainerReleationshipEditPart.VISUAL_ID:
			return createContainerReleationship_4004(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createClient_2001(EObject domainElement, View containerView,
		...
		node.setType(ModelVisualIDRegistry.getType(ClientEditPart.VISUAL_ID));
		...
		Node label5005 = createLabel(node,
				ModelVisualIDRegistry.getType(ClientOsEditPart.VISUAL_ID));
	...
	public Node createDatabase_2002(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ModelVisualIDRegistry.getType(DatabaseEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5007 = createLabel(node,
				ModelVisualIDRegistry.getType(DatabaseOsEditPart.VISUAL_ID));
		Node label5008 = createLabel(node,
				ModelVisualIDRegistry
						.getType(DatabaseDatabaseEngineEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createJ2EEServer_2003(EObject domainElement,
		...
		node.setType(ModelVisualIDRegistry
				.getType(J2EEServerEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5012 = createLabel(node,
				ModelVisualIDRegistry.getType(J2EEServerNameEditPart.VISUAL_ID));
		Node label5013 = createLabel(node,
				ModelVisualIDRegistry.getType(J2EEServerOsEditPart.VISUAL_ID));
		createCompartment(
				node,
				ModelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createBrowser_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ModelVisualIDRegistry.getType(BrowserEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createApplicationClient_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		...
		Node label5003 = createLabel(node,
				ModelVisualIDRegistry
						.getType(ApplicationClientLanguageEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createWebContainer_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		{
		...
		Node label5010 = createLabel(node,
				ModelVisualIDRegistry
						.getType(WebContainerServerAppEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEJBContainer_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		{
	 ...
	 * @generated
	 */
	public Edge createWebReleationship_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Edge createDataReleationship_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createAppReleationship_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createContainerReleationship_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
