 ...
 * @generated
 */
public class XMLConfigNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public XMLConfigNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.XMLConfigNameEditPart.VISUAL_ID));
		}
		return parser;
	}
