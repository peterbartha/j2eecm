 ...
 * @generated
 */
public class ServletNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ServletNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.ServletNameEditPart.VISUAL_ID));
		}
		return parser;
	}
