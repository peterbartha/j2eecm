...
import web.container.diagram.edit.policies.WebContainerCanonicalEditPolicy;
import web.container.diagram.edit.policies.WebContainerItemSemanticEditPolicy;
import web.container.diagram.part.ModelVisualIDRegistry;

/**
 * @generated
 */
public class WebContainerEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "WebContainer"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new WebContainerCanonicalEditPolicy());
