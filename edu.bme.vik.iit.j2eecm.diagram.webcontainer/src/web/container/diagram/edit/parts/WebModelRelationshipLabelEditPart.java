 ...
 * @generated
 */
public class WebModelRelationshipLabelEditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(web.container.diagram.edit.parts.WebModelRelationshipLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	 ...
	 * @generated
	 */
	public WebModelRelationshipLabelEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new WebContainerEditPart.LinkLabelDragPolicy());
	}
