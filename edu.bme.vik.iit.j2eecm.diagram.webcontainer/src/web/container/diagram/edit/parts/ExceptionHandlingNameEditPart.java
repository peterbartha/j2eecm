 ...
 * @generated
 */
public class ExceptionHandlingNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ExceptionHandlingNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.ExceptionHandlingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
