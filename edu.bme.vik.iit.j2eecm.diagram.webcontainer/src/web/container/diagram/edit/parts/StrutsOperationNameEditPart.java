 ...
 * @generated
 */
public class StrutsOperationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StrutsOperationNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.StrutsOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
