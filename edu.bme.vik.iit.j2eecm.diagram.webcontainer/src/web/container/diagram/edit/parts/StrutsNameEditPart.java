 ...
 * @generated
 */
public class StrutsNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StrutsNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.StrutsNameEditPart.VISUAL_ID));
		}
		return parser;
	}
