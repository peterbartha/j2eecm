 ...
 * @generated
 */
public class LinkElementLinkEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LinkElementLinkEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.LinkElementLinkEditPart.VISUAL_ID));
		}
		return parser;
	}
