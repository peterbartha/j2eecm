 ...
 * @generated
 */
public class EventCallNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventCallNameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.EventCallNameEditPart.VISUAL_ID));
		}
		return parser;
	}
