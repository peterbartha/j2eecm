 ...
 * @generated
 */
public class HTML5NameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HTML5NameEditPart(View view) {
		super(view);
	}
			...
			parser = ModelParserProvider
					.getParser(
							...
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.HTML5NameEditPart.VISUAL_ID));
		}
		return parser;
	}
