...
import web.container.diagram.edit.policies.ModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EventCallName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventCallName2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new WebContainerEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ModelParserProvider
					.getParser(
							ModelElementTypes.EventCall_3009,
							getParserElement(),
							ModelVisualIDRegistry
									.getType(web.container.diagram.edit.parts.EventCallName2EditPart.VISUAL_ID));
		}
		return parser;
	}
