 ...
 * @generated
 */
public class StrutsRelationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StrutsRelationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof StrutsRelation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStrutsRelation_4005(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		WebContainer container = (WebContainer) getLink().eContainer();
		return ModelBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistStrutsRelation_4005(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected StrutsRelation getLink() {
		return (StrutsRelation) getElementToEdit();
	}
