 ...
 * @generated
 */
public class StrutsExceptionHandlingCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getStruts_Actions();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getStrutsExceptionHandlingCompartment_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ExceptionHandlingEditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getStrutsExceptionHandlingCompartment_7007SemanticChildren((View) getHost()
						.getModel());
