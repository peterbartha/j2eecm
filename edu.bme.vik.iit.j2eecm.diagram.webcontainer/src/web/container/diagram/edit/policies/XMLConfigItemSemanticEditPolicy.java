 ...
 * @generated
 */
public class XMLConfigItemSemanticEditPolicy extends
		ModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public XMLConfigItemSemanticEditPolicy() {
		super(ModelElementTypes.XMLConfig_2006);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(incomingLink) == StaticRelationshipEditPart.VISUAL_ID) {
