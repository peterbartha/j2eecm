 ...
 * @generated
 */
public class J2EEServerWebContainerCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getJ2EEServer_WebContainer();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getJ2EEServerWebContainerCompartment_7003SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return WebContainerEditPart.VISUAL_ID == ModelVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ModelNodeDescriptor> childDescriptors = ModelDiagramUpdater
				.getJ2EEServerWebContainerCompartment_7003SemanticChildren((View) getHost()
						.getModel());
