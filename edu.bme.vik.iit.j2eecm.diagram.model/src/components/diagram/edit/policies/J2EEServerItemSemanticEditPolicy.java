...
import components.diagram.edit.commands.DataReleationshipCreateCommand;
import components.diagram.edit.commands.DataReleationshipReorientCommand;
 ...
 * @generated
 */
public class J2EEServerItemSemanticEditPolicy extends
		ModelBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public J2EEServerItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ModelVisualIDRegistry.getVisualID(outgoingLink) == DataReleationshipEditPart.VISUAL_ID) {
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (ModelElementTypes.DataReleationship_4002 == req.getElementType()) {
			return getGEFWrapper(new DataReleationshipCreateCommand(req,
	...
	protected Command getReorientRelationshipCommand(
		...
		case DataReleationshipEditPart.VISUAL_ID:
			return getGEFWrapper(new DataReleationshipReorientCommand(req));
		}
