...
public class PropertyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Property_propertyType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Property_propertyType_feature", "_UI_Property_type"),
				 ComponentsPackage.Literals.PROPERTY__PROPERTY_TYPE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ComponentsPackage.Literals.PROPERTY__TYPE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Property.class)) {
			case ComponentsPackage.PROPERTY__PROPERTY_TYPE:
